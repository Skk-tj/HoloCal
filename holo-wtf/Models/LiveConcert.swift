...
struct LiveConcert: Decodable, Hashable, Identifiable {
    ...
    static let previewConcert = LiveConcert(id: UUID(), title: "Iori Matsunaga Birthday Live Part 1", format: .both, jpyPrice: .multiTier(7000), platform: .zaiko, description: previewDescription, startTime: .now - 3600, imageUrl: URL(string: "https://teamup.com/12875225/attachment/01GT03M3BVXP8CKDW4WG4JFA95/preview/image.png?hash=f6d279ad8e76ba7aa793a95afc3acf90c8e4ea6fe509733d8e82c87ed8164034"), twitterUrl: URL(string: "https://twitter.com/iori_m_RIOT/status/1616289241906176004"), youtubeLink: nil, ticketLink: URL(string: "https://riotmusic-live.zaiko.io/item/354008"), officialLink: URL(string: "http://makeup.matereal.jp/"))
