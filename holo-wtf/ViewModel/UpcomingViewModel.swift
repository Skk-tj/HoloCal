...
class UpcomingViewModel: VideoViewModel {
    func getUpcoming() async {
        ...
        await getVideo(url: "https://holodex.net/api/v2/live?status=upcoming&type=stream&org=Hololive&include=songs&max_upcoming_hours=\(upcomingLookAhead)") { responseResult in
